...
$app_strings = array (
  ...
  'LBL_SMTPTYPE_EXCHANGE'                 => 'Microsoft Exchange',
    ...
    'ERR_GOTO_CLOUD_CONSOLE' => "Παρακαλώ πηγαίνετε στις ρυθμίσεις Cloud.",
    ...
    'ERR_UPDATE_PERSON_PRIMARY_EMAIL_IN_IDM_MODE_ADMIN' => 'Μπείτε στις ρυθμίσεις Cloud για να κάνετε αλλαγές στο πεδίο που είναι μόνο για ανάγνωση.',
