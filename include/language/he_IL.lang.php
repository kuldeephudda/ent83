...
$app_strings = array (
  ...
  שנה את הערך בבקשה.",
    ...
    'ERR_GOTO_CLOUD_CONSOLE' => "נא לעבור ל'הגדרות ענן'.",
    ...
    'ERR_UPDATE_PERSON_PRIMARY_EMAIL_IN_IDM_MODE_ADMIN' => 'עליך לגשת להגדרות הענן כדי לבצע שינויים בשדות המוגדרים לקריאה בלבד.',
