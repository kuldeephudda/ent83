...
$app_strings = array (
 ...
 Пожалуйста, измените значения.",
    ...
    'ERR_GOTO_CLOUD_CONSOLE' => "Перейдите в настройки облака.",
    ...
    'ERR_UPDATE_PERSON_PRIMARY_EMAIL_IN_IDM_MODE_ADMIN' => 'Чтобы изменить поля, доступные только для чтения, перейдите в настройки облака.',
