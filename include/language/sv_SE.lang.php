...
$app_strings = array (
 ...
 Vänligen ändra värdena.",
    ...
    'ERR_GOTO_CLOUD_CONSOLE' => "Vänligen gå till Cloud-inställningar.",
    ...
    'ERR_UPDATE_PERSON_PRIMARY_EMAIL_IN_IDM_MODE_ADMIN' => 'Vänligen gå in i Cloud-inställningar för att ändra fälten som bara kan läsas.',
