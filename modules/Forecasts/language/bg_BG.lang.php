...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Конфигурирайте как бихте желали да категоризирате {{forecastByModule}}. <br><br>Моля, обърнете внимание, че настойките на обхвата не могат да бъдат променени след първото подаване. За надградените екземпляри настройката "Обхват" е блокирана със съществуващите данни "Прогноза".<br><br>Можете да изберете две или повече категории на основата на обхвати на вероятност или да създадете категории, които не са на основата на вероятност. <br><br>Това са полета за отметки от лявата страна на вашите клиентски категории; използвайте ги, за да решите какви обхвати ще бъдат включени в количеството прогнози, подадени и докладвани на мениджърите. <br><br>Потребителят може да промени статуса "включи/изключи" и категорията на {{forecastByModule}} ръчно от своите планове.',
