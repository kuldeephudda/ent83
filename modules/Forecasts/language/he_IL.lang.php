...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'הגדר את האופן שבו ברצונך לסווג את {{forecastByModule}}. <br><br>לתשומת לבך, לא ניתן לשנות את הגדרות הטווח לאחר פעולת ההתחייבות הראשונה. למופעים ששודרגו, הגדרת הטווח נעולה עם נתוני התחזית הקיימים.<br><br>באפשרותך לבחור שתי קטגוריות או יותר על פי טווחי ההסתברות או ליצור קטגוריות שאינן מסתמכות על הסתברות. <br><br>קיימות תיבות סימון משמאל לקטגוריות שהתאמת אישית; ניתן להשתמש בהן כדי להחליט אילו טווחים ייכללו בסכום התחזית שעליה נערכו התחייבות ודיווח למנהלים. <br><br>A המשתמש יוכל לכלול/לא לכלול סטטוס וקטגוריה מתוך {{forecastByModule}} באופן ידני מגיליון העבודה שלו.',
