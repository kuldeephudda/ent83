...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => '{{forecastByModule}} の分類方法を設定します。 <br><br>範囲設定は、最初のコミット後は変更できませんのでご注意ください。アップグレードされたインスタンスでは、既存の予測データで範囲設定がロックされます。<br><br>確率範囲に基づく2つ以上のカテゴリを選択または、確率に基づいていないカテゴリを作成することができます。<br><br>カスタム カテゴリの左側にチェック ボックスがあります。これらを使用して、どの範囲をコミットする予測金額内に含め、マネージャーに報告するかを決定します。<br><br>ユーザーは、{{forecastByModule}} のステータスおよびカテゴリをそれらのワークシートに含める／除外するかを手動で変更することができます。',
