...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurere hvordan du vil kategorisere {{forecastByModule}}. <br><br>Vær oppmerksom på at områdeinnstillingene ikke kan endres etter første skriving. For oppgraderte tilfeller, er innstillingen Utvalg låst med eksisterende prognosedata.<br><br>Du kan velge to eller flere kategorier basert på sannsynlighetsområder eller opprette kategorier som ikke er basert på sannsynlighet. <br><br>Det er avmerkingsboksene til venstre for egendefinerte kategorier; Bruk disse til å bestemme hvilke områder som vil bli inkludert i prognosemengde forpliktet og rapportert til ledere. <br><br>En bruker kan endre inkludere/ekskludere-status og kategori av {{forecastByModule}} manuelt fra deres regneark.',
