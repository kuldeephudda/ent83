...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configureer hoe u {{forecastByModule}} wilt categoriseren. <br><br>Houd er rekening mee dat de Bereikinstellingen niet kunnen worden veranderd nadat deze voor het eerst zijn bepaald. Bij vernieuwde versies is de Bereikinstelling vergrendeld in de huidige Voorspellingsgegevens.<br><br>U kunt twee of meer categorieën selecteren op basis van het waarschijnlijkheidsbereik of u kunt categorieën aanmaken die daar niet op gebaseerd zijn. <br><br>Er zijn selectievakjes links van uw aangepaste categorieën: gebruik deze om te bepalen welk bereik wordt opgenomen in het ingevoerde voorspellingsbedrag en aan managers wordt gerapporteerd. <br><br>Een gebruiker kan de status insluiten/uitsluiten en de categorie {{forecastByModule}} handmatig veranderen vanuit het werkblad.',
