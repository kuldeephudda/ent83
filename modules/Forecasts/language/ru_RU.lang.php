...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Укажите способ классификации {{forecastByModule}}. <br><br>Обратите внимание, что после первого утверждения нельзя изменить настройки диапазона. Для обновленных экземпляров настройки диапазона блокируются вместе с имеющимися данными прогноза.<br><br>Можно выбрать две или несколько категорий на основе диапазонов вероятности или создать категории, которые не базируются на вероятности. <br><br>Слева от пользовательских категорий находятся флажки. Установите их возле диапазонов, которые нужно включить в прогноз относительно использованной суммы и отправить руководителям. <br><br>Пользователь может вручную изменить статус включения/исключения и категорию {{forecastByModule}} со своего рабочего листа.',
