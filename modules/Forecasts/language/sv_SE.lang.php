...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurera hur du vill kategorisera {{forecastByModule}}. <br><br>Observera att intervallinställningarna inte kan ändras efter den första utförandet. För uppgraderade instanser är intervallinställningen låst med befintlig prognosdata.<br><br>Du kan välja två eller fler kategorier baserat på sannolikhetsintervallen eller skapa kategorier som inte baseras på sannolikhet. <br><br>Det finns kryssrutor till vänster om dina anpassade kategorier; använd dessa för att bestämma vilka intervall som kommer att inkluderas inom prognosbeloppet och rapporteras till chefer. <br><br>En användare kan ändra inkludera/utesluta-statusen och kategori av {{forecastByModule}} manuellt från sina kalkylblad.',
