...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'กำหนดว่าคุณต้องการจัดประเภทหมวดหมู่อย่างไร {{forecastByModule}} <br><br>โปรดทราบว่าการตั้งค่าช่วงพิสัยจะไม่สามารถเปลี่ยนแปลงได้หลังจากที่ยืนยันไปแล้วในครั้งแรก การตั้งค่าช่วงพิสัยจะถูกล็อกไว้กับข้อมูลพยากรณ์ที่มีอยู่ <br><br>คุณอาจเลือกหมวดหมู่จำนวนสอง หรือมากกว่าสองหมวดหมู่ขึ้นอยู่กับช่วงพิสัยที่เป็นไปได้ หรือสร้างหมวดหมู่ที่ไม่ขึ้นอยู่กับความน่าจะเป็น <br><br>จะมีกล่องสี่เหลี่ยมให้ทำเครื่องหมายทางด้านซ้ายของหมวดหมู่ที่ออกแบบเอง กรุณาใช้หมวดหมู่เหล่านี้ในการตัดสินใจเลือกช่วงพิสัยที่จะเอามารวมไว้ในจำนวนพยากรณ์ที่ยืนยัน และรายงานไปยังผู้จัดการแล้ว <br><br>ผู้ใช้สามารถเปลี่ยนสถานะรวม/ไม่รวม และหมวดหมู่ของ {{forecastByModule}} ได้เองจากแผ่นงานของตน',
