...
'help'=>array(
    ...
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
        'defaultquickcreate'=>'<b>Paigutuse</b> ala sisaldab välju, mida praegu näidatakse <b>Kiirgeneraatori</b> vormil.<br><br>Kiirgeneraatori vorm ilmub mooduli alampaneelidesse, kui klõpsatakse nuppu Create.<br/><br/> <b>Tööriistakast</b> sisaldab <b>Prügikasti</b> ja välju ning paigutuse elemente, mida saab paigutusele lisada.<br><br>Tehke paigutusele muudatusi pukseerides elemente ja välju <b>Tööriistakasti</b> ja <b>Paigutuse vahel</b> ning paigutuse enda sees.<br><br>Paigutusest välja eemaldamiseks pukseerige väli <b>Prügikasti</b>. Siis on väli Tööriistakastis saadaval ja seda saab paigutusele lisada.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Näitab sõltuvat välja, mis võib olla nähtav või nähtamatu olenevalt valemi väärtusest.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Näitab arvutatud välja, mille väärtus määratakse valemi põhjal automaatselt.'
    ,
...
'LBL_CONFIRM_FIELD_DELETE'=>'Selle kohandatud välja kustutamine kustutab nii kohandatud välja kui ka kõik andmebaasis kohandatud väljaga seotud andmed. Välja ei kuvata enam üheski mooduli paigutuses.'
        ...
        . '\\n\\nKas soovite jätkata?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Kas olete kindel, et soovite selle seose kustutada?<br>Märkus: see toiming võib võtta mitu minutit.',
...
'LBL_POPHELP_CALCULATED'=>"Looge selle välja väärtuse määramiseks valem.<br>"
   . "Töövoo definitsioonid, mis sisaldavad tegevust, mis on määratud seda välja uuendama, ei käivita enam tegevust.<br>"
   . "Valemeid kasutavaid välju ei arvutata reaalajas "
   . "Sugari iseteenindusportaalis ega "
   . "Mobiilsetes redigeerimisvaadetes.",

'LBL_POPHELP_DEPENDENT'=>"Looge valem määramaks, kas see väli on paigutustes nähtav.<br/>"
        . "Sõltuvad väljad järgivad brauseripõhises mobiilivaates sõltuvusvalemit,<br/>"
        . "aga ei järgi valemit sellistes omarakendustes nagu Sugar Mobile iPhone'ile.<br/>"
        . "Need ei järgi Sugari iseteenindusportaali valemit.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Valige selle välja kasutamine selle mooduli globaalse otsingu abil kirjeid otsides.',
