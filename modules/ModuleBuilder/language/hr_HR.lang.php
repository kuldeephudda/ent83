...
'help'=>array(
    ...
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označava zavisno polje koje može ili ne mora biti vidljivo na temelju vrijednosti formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označava izračunato polje čija će se vrijednost automatski odrediti na temelju formule.'
    ,
        'defaultquickcreate'=>'Područje <b>izgleda</b> sadrži polja koja se trenutačno prikazuju unutar obrasca za <b>brzo stvaranje</b>.<br><br>Obrazac za brzo stvaranje pojavljuje se u podpločama za modul nakon što se klikne gumb Stvaranje.<br/><br/><b>Alatni okvir</b> sadrži <b>Koš za smeće</b> te polja i elemente izgleda koji se mogu dodati izgledu.<br><br>Promijenite izgled tako da povučete i ispustite elemente i polja između <b>Alatnog okvira</b> i <b>Izgleda</b> te unutar samog izgleda.<br><br>Da biste uklonili polje iz izgleda, dovucite polje u <b>Koš za smeće</b>. Polje će zatim biti dostupno u alatnom okviru za dodavanje izgledu.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označava zavisno polje koje može ili ne mora biti vidljivo na temelju vrijednosti formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označava izračunato polje čija će se vrijednost automatski odrediti na temelju formule.'
    ,
...
,
'LBL_POPHELP_CALCULATED'=>"Izradite formulu za određivanje vrijednosti u ovom polju.<br>"
   . "Definicije tijeka rada koje sadržavaju radnju i koje su postavljene za ažuriranje ovog polja više neće izvršavati tu radnju.<br>"
   . "Polja koja upotrebljavaju formule neće se izračunati u stvarnom vremenu u "
   . "Samouslužnom portalu korisnika ili "
   . "izgledima Mobilnog prikaza za uređivanje.",

'LBL_POPHELP_DEPENDENT'=>"Izradite formulu za određivanje je li ovo polje vidljivo u izgledima.<br/>"
        ...
        . "Neće slijediti formulu u Samouslužnom portalu korisnika.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Odaberite za uporabu ovog polja pri pretraživanju zapisnika s pomoću globalnog pretraživanja na ovom modulu.',
