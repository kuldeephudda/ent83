...
'LBL_CONFIRM_FIELD_DELETE'=>'Pašalinus šį pasirinktinį lauką bus pašalintas ir laukas, ir visi su pasirinktiniu lauku susiję duomenys duomenų bazėje. Laukas nebebus rodomas nė viename modulio makete.'
        ...
        . '\\n\\nAr norite tęsti?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Tikrai norite ištrinti šį ryšį?<br>Pastaba. Ši operacija gali būti atliekama ilgiau nei keletą minučių.',
...
,
'LBL_POPHELP_CALCULATED'=>"Sukurkite formulę, kad šiame lauke nustatytumėte vertę.<br>"
   . "Darbo eigos apibrėžimuose, kuriuose įtrauktas veiksmas, nustatytas šiam laukui atnaujinti, šis veiksmas nebebus vykdomas.<br>"
   . "Laukų, kuriuose naudojamos formulės, reikšmės nebus apskaičiuojamos realiu laiku, naudojant "
   . "„Sugar“ savitarnos portalą arba "
   . "mobilias redagavimo formas.",

'LBL_POPHELP_DEPENDENT'=>"Sukurkite formulę, kad nustatytumėte, ar šis laukas turi būti rodomas formoje.<br/>"
        . "Priklausomuose laukuose, dirbant mobiliojoje interneto naršyklėje, bus taikoma priklausomybės formulė, <br/>"
        . "tačiau vietinėse programose, pvz., „Sugar Mobile“, skirtoje „iPhone“, formulė taikoma nebus.<br/>"
        . "„Sugar“ savitarnos portalo priklausomuose laukuose formulė taip pat nebus taikoma.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Pasirinkite, kad laukas būtų naudojamas, kai įrašų ieškote šiame modulyje naudodami globalią paiešką.',
