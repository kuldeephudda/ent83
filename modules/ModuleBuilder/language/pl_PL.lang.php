...
'help'=>array(
    ...
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Wskazuje pole zależne, które może być widoczne lub niewidoczne w zależności od wartości wzoru.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Wskazuje obliczone pole, którego wartość zostanie automatycznie określona na podstawie wzoru.'
    ,
...
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Czy na pewno chcesz usunąć tę relację?<br>Uwaga: operacja może zostać ukończona dopiero po kilku minutach.',
...
,
'LBL_POPHELP_CALCULATED'=>"Utwórz formułę do określania wartości tego pola.<br>"
   . "Definicje workflow zawierające działanie, które są ustawione na aktualizację tego pola, nie będą już powodować wykonania tego działania.<br>"
   . "Pola wykorzystujące formuły nie będą obliczane w czasie rzeczywistym w "
   . "portalu samoobsługowym Sugar lub "
   . "układach Mobilny widok edycji.",

'LBL_POPHELP_DEPENDENT'=>"Utwórz formułę służącą do określania, czy to pole jest widoczne w układach.<br/>"
        . "Wartości pól zależnych będą określane zgodnie z formułą zależności w mobilnych widoku przeglądarki,<br/>"
        . "ale nie będą obliczane na podstawie tej formuły w natywnych aplikacjach, takich jak Sugar Mobile for iPhone.<br/>"
        . "Nie będzie też wykorzystywana w portalu samoobsługowym Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Zaznacz, aby używać tego pola podczas wyszukiwania rekordów za pomocą funkcji Wyszukiwanie globalne w tym module.',
