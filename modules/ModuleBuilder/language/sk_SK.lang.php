...
'LBL_POPHELP_CALCULATED'=>"Vytvorte vzorec na určenie hodnoty v tomto poli.<br>"
   ...
   . "Polia používajúce vzorce sa nebudú vypočítavať v reálnom čase na "
   . "samoobslužnom portáli Sugar alebo "
   . "rozloženiach na úpravy pre mobilné telefóny.",

'LBL_POPHELP_DEPENDENT'=>"Vytvorte vzorec na určenie, či je toto pole viditeľné v rozloženiach.<br/>"
        . "Závislé polia budú sledovať vzorec závislosti v mobilnom zobrazení založenom na prehliadači, <br/>"
...
'LBL_POPHELP_GLOBAL_SEARCH'=>'Vyberte na použitie toto pole, keď vyhľadávate záznamy pomocou globálneho vyhľadávania v tomto module.',
