...
- تتوفر إجراءات إضافية في قائمة الإجراءات المنسدلة إلى يمين الزر "تحرير".',
    ...
    'LBL_HELP_CREATE' => 'تسمح وحدة {{plural_module_name}} لك بتتبع المبيعات الفردية والبنود التي تنتمي إلى هذه المبيعات من البداية إلى النهاية. يمثل كل سجل {{module_name}} مبيعات متوقعة ويتضمن بيانات مبيعات ذات صلة ويرتبط كذلك بسجلات مهمة أخرى مثل {{quotes_module}} و{{contacts_module}}، إلخ.
