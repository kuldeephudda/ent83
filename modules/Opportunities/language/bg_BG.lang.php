...
//END DON'T CONVERT
    ...
    'LBL_WORKSHEET' => 'План',
    'LBL_COMMENTLOG' => 'Регистър на коментари',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модулът {{plural_module_name}} дава възможност за проследяване на отделните продажби от началото до края. Всеки запис в модула {{module_name}} представлява потенциална продажба и включва данни за съответната продажба, както и за други важни записи, като {{quotes_module}}, {{contacts_module}} и т.н. {{module_name}} обикновено преминава през няколко Етапа на преговори, докато не бъде отбелязан като „Спечелен“ или „Загубен“. {{plural_module_name}} може да бъде разширен допълнително с помощта на модула {{forecasts_singular_module}} на Sugar, за да бъдат разбрани и предсказани тенденциите в продажбите, както и за фокусиране на работата върху постигане на квотите за продажби.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} дава възможност за проследяване на всяка продажба и свързаните с нея елементи от началото до края. Всеки запис в {{module_name}} представлява потенциална продажба и включва съответните данни за продажбата, както и такива, отнасящи се до други важни записи, като {{quotes_module}}, {{contacts_module}} и т.н.

- Редактирайте полетата на този запис, като щракнете върху конкретно поле или бутона „Редактирай“.
- Разглеждайте или модифицирайте връзките към други записи в панелите със свързани записи, като зададете опцията „Данни“ за долния ляв панел.
- Оставяйте коментари, преглеждайте коментарите на потребителите и записвайте историята на извършените промени в {{activitystream_singular_module}}, като зададете опцията „Дейности“ за долния ляв панел.
- Следвайте или задавайте като предпочитан текущия запис, като използвате иконите вдясно от името на записа.
- Можете да извършвате допълнителни действия, като използвате падащото меню „Действия“ вдясно от бутона „Редактирай“.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} дава възможност за проследяване на всяка продажба и свързаните с нея елементи от началото до края. Всеки запис в {{module_name}} представлява потенциална продажба и включва съответните данни за продажбата, както и такива, отнасящи се до други важни записи, като {{quotes_module}}, {{contacts_module}} и т.н.

За да създадете {{module_name}}:
1. Въведете стойности в съответните полета.
 - Полетата, отбелязани като „Задължителни“, трябва да бъдат попълнени преди съхраняване на записа.
 - Щракнете върху „Покажи повече“, за да се покажат допълнителни полета, ако е необходимо.
2. Щракнете върху „Съхрани“, за да запазите новия запис и да се върнете на предходната страница.',
