...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Registre de comentaris',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El mòdul {{plural_module_name}} us permet seguir les vendes individuals de principi a fi. Cada registre {{module_name}} representa una possible venda i inclou les dades de venda corresponents, a més d&#39;altres relacionades amb altres registres importants com ara {{quotes_module}}, {{contacts_module}}, etc. Un {{module_name}} habitualment progressa a través de diverses etapes de vendes fins que es marca "Tancat guanyat" o "Tancat perdut". {{plural_module_name}} es poden aprofitar encara més si s&#39;utilitza el modul {{forecasts_singular_module}} de sugar per entendre i predir tendències de vendes, així com centrar el treball per assolir els objectius de vendes.',
