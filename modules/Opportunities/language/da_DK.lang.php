...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Kommentarregister',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} -modulet giver dig mulighed at spore individuelle salg fra start til slut. Hver {{module_name}} post repræsenterer et potentielt salg og omfatter relevante salgsdata samt vedrører andre vigtige poster såsom {{quotes_module}}, {{contacts_module}} osv. En {{module_name}} vil typisk gå videre gennem flere salgsfaserne, indtil det markeres som enten "Lukket vundet" eller "Lukket tabt". {{plural_module_name}} kan udnyttes yderligere ved hjælp af sukkers {{forecasts_singular_module}}ing modul til at forstå og forudsige salgstendenser samt fokusarbejde for at opnå salgskvoter.',
...
- Tilføj og vis brugerkommentarer, og registrér ændringer i historikken i {{activitystream_singular_module}} ved at skifte den nederste venstre rude over til "Activity Stream". 
