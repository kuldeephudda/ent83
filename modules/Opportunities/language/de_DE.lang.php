...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Kommentarprotokoll',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe von Anfang bis Ende nachverfolgen. Jeder Datensatz {{module_name}} stellt einen potentiellen Verkauf dar und umfasst sowohl relevante Verkaufsdaten als auch einen Bezug auf andere wichtige Datensätze, wie z. B. {{quotes_module}}, {{contacts_module}} usw. Ein {{module_name}} durchläuft in der Regel verschiedene Verkaufsphasen, bis er entweder als „Gewonnen“ oder „Verloren“ markiert wird. {{plural_module_name}} kann des Weiteren mithilfe von Sugars Modul {{forecasts_singular_module}} auch dazu genutzt werden, Trends bei Verkäufen besser zu verstehen sowie vorherzusagen und es erlaubt, die Arbeit noch mehr auf das Erreichen der Verkaufsquoten zu konzentrieren.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe samt dazugehöriger Produkte von Anfang bis Ende nachverfolgen. Jeder Datensatz {{module_name}} stellt einen potentiellen Verkauf dar und umfasst sowohl relevante Verkaufsdaten als auch einen Bezug auf andere wichtige Datensätze, wie z. B. {{quotes_module}}, {{contacts_module}} usw.

- Bearbeiten Sie die einzelnen Felder des Datensatzes, indem Sie auf ein Feld oder auf die Schaltfläche „Bearbeiten" klicken
- Sehen Sie sich Links zu anderen Datensätzen an oder bearbeiten Sie diese in den Sub-Panels, indem Sie den linken unteren Bereich auf „Datenansicht" stellen".
