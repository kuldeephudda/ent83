...
υπόδειγμά σας θα πρέπει να διαμορφωθεί για την αποστολή email μέσω του Admin > Email Settings για να είναι εφικτή η αποστολή ειδοποιήσεων.',
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η λειτουργική μονάδα {{plural_module_name}} σας επιτρέπει να παρακολουθείτε τις μεμονωμένες πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια προοπτική πώλησης και περιλαμβάνει δεδομένα σχετικά με την πώληση, καθώς και δεδομένα σχετικά με άλλες σημαντικές εγγραφές όπως {{quotes_module}}, {{contacts_module}}, κλπ. Μία {{module_name}} συνήθως θα μεταπέσει μέσα από διάφορα στάδια πωλήσεων, έως ότου επισημανθεί είτε ως «Έκλεισε Κερδισμένη» είτε «Έκλεισε Χαμένη». Η {{plural_module_name}} μπορεί να ενισχυθεί ακόμη περισσότερο, χρησιμοποιώντας την μονάδα {{forecasts_singular_module}} του Sugar για να κατανοήσετε και προβλέψετε τάσεις πωλήσεων, καθώς και για να επικεντρώσετε τις προσπάθειές σας στην επίτευξη ποσοστώσεων πωλήσεων.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Η μονάδα {{plural_module_name}} σας δίνει τη δυνατότητα να παρακολουθείτε τις ξεχωριστές πωλήσεις και τα είδη γραμμής που περιλαμβάνονται στις συγκεκριμένες πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια πιθανή πώληση και περιλαμβάνει δεδομένα σχετικά με την πώληση, καθώς και δεδομένα που σχετίζονται με άλλες σημαντικές εγγραφές όπως {{quotes_module}}, {{contacts_module}}, κ. τ. λ.
...
- Διατυπώστε και εμφανίστε σχόλια χρήστη και καταγράψτε τις αλλαγές εγγραφών στο {{activitystream_singular_module}} με εναλλαγή στο κάτω αριστερά παράθυρο μέχρι το «Ροή Δραστηριότητας».
...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού Ενεργειών στα δεξιά του πλήκτρου Τροποποιήσεων.',
    ...
    'LBL_HELP_CREATE' => 'Η μονάδα {{plural_module_name}} σας επιτρέπει να παρακολουθείτε τις μεμονωμένες πωλήσεις και τα στοιχεία γραμμής που ανήκουν στις συγκεκριμένες πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια προοπτική πώλησης και περιλαμβάνει δεδομένα σχετικά με την πώληση καθώς και δεδομένα σχετικά με άλλες σημαντικές εγγραφές όπως {{quotes_module}}, {{contacts_module}}, κλπ.

Για να δημιουργήσετε μία {{module_name}}:
1. Καταχωρήστε τιμές για τα πεδία βάσει των επιλογών σας.
