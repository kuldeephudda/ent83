...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Registro de comentarios',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El módulo {{plural_module_name}} le permite realizar un seguimiento de las ventas individuales de principio a fin. Cada registro de {{module_name}} representa una venta potencial e incluye datos de venta relevantes, además de datos relacionados con otros registros importantes como {{quotes_module}}, {{contacts_module}}, etc. Un{{module_name}} normalmente avanzará a través de numerosas etapas de ventas hasta que se marque como "Cerrado ganado" o "Cerrado perdido". {{plural_module_name}} se puede aprovechar aún más con el módulo {{forecasts_singular_module}} de Sugar para entender y predecir las tendencias de ventas, así como para centrar el trabajo y conseguir los objetivos de ventas.',
