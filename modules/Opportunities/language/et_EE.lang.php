...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Kommentaaride logi',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} moodul võimaldab teil jälgida üksikuid müüke algusest lõpuni. Iga {{module_name}} kirje esindab potentsiaalset müüki ning sisaldab asjakohaseid müügiandmeid ning muid olulisi kirjeid, nagu{{quotes_module}}, {{contacts_module}}, jne. {{module_name}} läbib tavaliselt mitu müügietappi, kuni see märgitakse kas "suletud võiduks" või "suletud kaotuseks". {{plural_module_name}} on võimalik veelgi võimendada, kasutades Sugari {{forecasts_singular_module}} moodulit, et mõista ja prognoosida müügitrende ning keskenduda töös müügikvootide täitmisele.',
...
- Redigeerige selle kirje välju, klõpsates individuaalsel väljal või nupul Redigeeri.
- Vaadake või muutke alampaneelides linke teistele kirjetele, valides alumisel vasakpoolsel paanil kuva Andmevaade. 
- Koostage ja vaadake kasutaja kommentaare ning salvestage muutuste ajalugu moodulis {{activitystream_singular_module}}, valides alumisel vasakpoolsel paanil kuva "Tegevuste voog". 
...
- Täiendavad toimingud on saadaval tegevuste rippmenüüs, mis asub nupust Redigeeri paremal.',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}} moodul võimaldab teil üksikuid müüke ja nende müükide juurde kuuluvaid reaüksusi algusest lõpuni jälgida. Iga {{module_name}} kirje tähistab potentsiaalset müüki ja sisaldab asjakohaseid müügiandmeid ning muid olulisi kirjeid nagu {{quotes_module}}, {{contacts_module}} jms.

Mooduli {{module_name}} loomiseks: 
1. Esitage vastavalt soovile väljade väärtused. 
 - Väljad märkega "Kohustuslik" tuleb täita enne salvestamist. 
 - Vajaduse korral lisaväljade avaldamiseks klõpsake "Kuva rohkem". 
