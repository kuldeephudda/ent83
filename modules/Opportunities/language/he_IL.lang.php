...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'המודול/ים &#39;{{plural_module_name}}&#39; מאפשר/ים לך לעקוב אחרי מכירות נפרדות מתחילת התהליך ועד סופו. כל רשומה של המודול {{module_name}} מייצגת מכירה פוטנציאלית וכוללת נתונים רלוונטיים לגבי המכירה ולגבי רשומות חשובות אחרות כגון {{quotes_module}}, {{contacts_module}} וכדומה. המודול {{module_name}} יוכל להתקדם בדרך כלל מספר שלבי מכירות עד שיסומן כ"נסגר בהצלחה" או "נסגר ואבד". ניתן למנף את המודול/ים &#39;{{plural_module_name}}&#39; אפילו יותר באמצעות שימוש במודול {{forecasts_singular_module}} של Sugar כדי להבין ולחזות מגמות מכירות ולהתמקד בעבודה כדי להשיג את מכסות המכירות.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'המודול/ים {{plural_module_name}} מאפשר/ים לך לעקוב אחר מכירות בודדות ופריטי שורה השייכים למכירות אלה מתחילת התהליך ועד לסופו. כל רשומה של {{module_name}} מייצגת מכירה צפויה וכוללת מידע רלוונטי לגבי המכירה כמו גם לגבי רשומות חשובות אחרות כגון {{quotes_module}}, {{contacts_module}}, וכדומה.
...
- פעולות נוספות זמינות בתפריט הנפתח "פעולות" מימין ללחצן "ערוך".',
    ...
    'LBL_HELP_CREATE' => 'המודול/ים {{plural_module_name}} מאפשר/ים לך לעקוב אחר מכירות בודדות ופריטי שורה השייכים למכירות אלה מתחילת התהליך ועד לסיומו. כל רשומה של {{module_name}} מייצגת מכירה צפויה וכוללת מידע רלוונטי לגבי המכירה וכן לגבי רשומות חשובות אחרות כגון {{quotes_module}}‏, {{contacts_module}} וכדומה.

כדי ליצור מודול {{module_name}}:
1. הזן ערכים בשדות, לפי הצורך.
 - יש למלא שדות המסומנים כ"נדרש/חובה" לפני השמירה.
