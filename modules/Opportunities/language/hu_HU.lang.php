...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Megjegyzés napló',
...
- Tekintse meg, vagy szerkessze az alpanelekben található egyéb rekordokra mutató linkeket a bal alsó „Adatnézet” kapcsoló használatával!
- Írjon vagy olvasson felhasználói hozzászólásokat, illetve rögzítsen módosítási előzményeket a(z) {{activitystream_singular_module}} részben a bal alsó tábla „Adatfolyam” megjelenítésre változtatásával.
- A rekord neve mellett található ikonok segítségével jelölje be kedvencének a tartalmat, vagy kövesse annak utóéletét!
- Egyéb tevékenységek a Szerkesztés gombtól jobbra található Műveletek gomb legördülő menüjében találhatók.',
...
1. Adja meg a szükséges értékeket az adott mezőkben.
 - A „kötelező” címkével rendelkező mezők kitöltése nélkül mentés nem lehetséges.
