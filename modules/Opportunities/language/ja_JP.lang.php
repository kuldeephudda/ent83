...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}モジュールを使えば、初めから終わりまで、個々の売上を追跡できます。 {{module_name}}の各レコードは見込みの売上を示しており、関連する売上データや、{{quotes_module}}、{{contacts_module}}などの重要な他のレコードに関連するデータが含まれています。 通常、{{module_name}}は「受注」あるいは「失注」としてマークされるまで、複数の商談ステージを進んでいきます。また、Sugarの{{forecasts_singular_module}}モジュールを使えば{{plural_module_name}}がさらに便利になり、売上の傾向を把握・予測したり、ノルマを達成するために作業に集中したりできるようになります。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} モジュールを使用することで、個々の商談と、それらの商談に
属している商品を開始から終了まで追跡できます。{{module_name}}の各レコードは見込みの売上を示しており、関連する売上データや、{{quotes_module}}、{{contacts_module}}などの重要な他のレコードに関連するデータが含まれています。 
