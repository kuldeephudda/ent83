...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Komentāru žurnāls',
...
// BEGIN ENT/ULT
    ...
    'LBL_HELP_RECORD' => 'Modulis {{plural_module_name}} ļauj sekot atsevišķiem pārdošanas darījumiem un tiem piederošiem rindas vienumiem no sākuma līdz beigām. Katrs moduļa {{module_name}} ieraksts ir potenciāls pārdošanas darījums, un tas ietver atbilstošu pārdošanas informāciju, kā arī ir saistīts ar citiem svarīgiem ierakstiem, piemēram, moduļiem {{quotes_module}}, {{contacts_module}} u. c. 

- Rediģējiet ieraksta laukus, klikšķinot uz laukiem vai pogas "Rediģēt".
- Apskatiet vai pārveidojiet saites uz citiem ierakstiem, apakšpaneļos ieslēdzot datu skatu kreisajā apakšējā panelī.
