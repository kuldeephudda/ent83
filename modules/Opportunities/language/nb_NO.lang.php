...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulen {{plural_module_name}}-lar deg spore individuelle salg fra start til slutt. Hver {{module_name}} representerer et potensielt salg og inkluderer relevante salgsdata så vel som relatert til andre viktige poster som {{quotes_module}}, {{contacts_module}}, osv. Et {{module_name}} vil typisk gå videre gjennom flere salgsstadier til det er merket enten "Lukket vunnet" eller "Lukket tapt". {{plural_module_name}} kan påvirkes ytterligere ved å bruke Sugars {{forecasts_singular_module}}-modul for å forstå og forutsi salgstrender så vel som fokusere arbeidet på å oppnå salgstilbud.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulen {{plural_module_name}} lar deg spore individuelle salg og linjeelementer som tilhører disse salgene fra start til slutt. Hver {{module_name}}-post representerer et potensielt salg og inkluderer relevante salgsdata så vel som relatert til andre viktige poster som {{quotes_module}}, {{contacts_module}}, osv.

- Rediger denne postens felt ved å klikke på et individuelt felt eller knappen Rediger.
- Vis eller endre koblinger til andre poster i underpanelene ved å veksle nedre venstre rute til "Datavisning".
...
- Følg eller sett denne posten som favoritt med ikonene til høyre for postnavnet.
- Tilleggshandlinger er tilgjengelig i nedtrekksmenyen Handlinger til høyre for Rediger-knappen.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulen {{plural_module_name}} lar deg spore individuelle salg og linjeelementene som tilhører disse salgene fra start til slutt, Hver {{module_name}}-post representerer et potensielt salg og inkluderer relevante salgsdata så vel som relatert til andre viktige poster som {{quotes_module}}, {{contacts_module}}, osv.

For å opprette et {{module_name}}:
1. Oppgi verdier for feltene ved behov.
 - Felt merket "Obligatorisk" må fullføres før de lagres.
 - Klikk "Vis mer" for å vise flere felt og gå tilbake til den forrige siden.
