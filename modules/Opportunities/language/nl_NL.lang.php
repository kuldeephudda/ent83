...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Met de {{plural_module_name}} module kunt u van begin tot eind de individuele verkoop volgen. Elk {{module_name}} record vertegenwoordigt een mogelijke verkoop en omvat zowel relevante verkoopgegevens als gegevens die betrekking hebben op andere belangrijke records, zoals {{quotes_module}}, {{contacts_module}}, etc. Een {{module_name}} doorloopt doorgaans meerdere verkoopfases tot deze als "Gesloten, gewonnen" of "Gesloten, verloren" gemarkeerd wordt. {{plural_module_name}} kan nog verder worden uitgebreid met de {{forecasts_singular_module}} module van Sugar om verkooptrends te begrijpen en te voorspellen, en om werk specifiek te richten op het bereiken van verkoopquota&#39;s.',
...
1. Voer de gewenste waarden van de velden in.
 - Velden die als "Verplicht" zijn gemarkeerd, moeten worden ingevuld voordat u ze opslaat.
 - Klik op "Meer" om indien nodig extra velden te tonen.
