...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Registo de comentários',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'O módulo {{plural_module_name}} permite controlar as vendas individuais do início ao fim. Cada registro de {{module_name}} representa uma possível venda e inclui dados de vendas relevantes, bem como referente a outros registos importantes, tais como {{quotes_module}}, {{contacts_module}} etc. Um {{module_name}} normalmente avança por vários estágios de vendas até ser marcado como "Ganho Fechado" ou "Perda Fechado". Os {{plural_module_name}} podem ser mais aproveitados com o uso do módulo {{forecasts_singular_module}} do Sugar para entender e prever as tendências de vendas, além de concentrar o trabalho para alcançar as cotas de vendas.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'O módulo {{plural_module_name}} permite controlar as vendas individuais e os itens de linha pertencentes a essas vendas do início ao fim. Cada registo de {{module_name}} representa uma possível venda e inclui dados de vendas relevantes, bem como referente a outros registos importantes, tais como {{quotes_module}}, {{contacts_module}} etc.

- Para editar os campos do registo, clique em um campo individual ou no botão Editar.
