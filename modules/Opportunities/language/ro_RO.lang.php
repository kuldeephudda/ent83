...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Jurnal de comentarii',
...
// BEGIN ENT/ULT
    ...
    'LBL_HELP_RECORD' => 'Modulul {{plural_module_name}} vă permite să monitorizați vânzările individuale și articolele aferente vânzărilor respective de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date de vânzare relevante, precum și date legate de alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc.
...
- Sunt disponibile acțiuni suplimentare în meniul vertical Acțiuni din dreapta butonului Editare.',
    ...
    'LBL_HELP_CREATE' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzările individuale și articolele aferente vânzărilor respective de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date de vânzare relevante, precum și date legate de alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc.
