...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Журнал комментариев',
...
- Чтобы редактировать поля записи, нажмите нужное поле или кнопку "Редактировать". 
