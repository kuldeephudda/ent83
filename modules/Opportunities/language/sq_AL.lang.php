...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Evidenca e komenteve',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moduli {{plural_module_name}} mundëson të gjurmimin e shitjeve individuale nga fillimi deri në fund. Çdo regjistrim i {{module_name}} përbën një shitje të mundshme dhe përfshin të dhënat përkatëse të shitjes dhe ndërlidhet me regjistrime të tjera të rëndësishme si p.sh. {{quotes_module}}, {{contacts_module}} etj. Zakonisht, një {{module_name}} do të kalojë në disa faza të shitjes derisa të shënohet si "Mbyllje me fitim" ose "Mbyllje me humbje". {{plural_module_name}} mund të përdoret edhe më tej duke përdorur modulin e {{forecasts_singular_module}} të "Sugar" për të kuptuar dhe parashikuar tendencat e shitjeve, si dhe për t&#39;u përqendruar në arritjen e kuotave të shitjeve.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Moduli {{plural_module_name}} mundëson gjurmimin e shitjeve individuale dhe artikujt e linjës që u përkasin atyre shitjeve nga fillimi në fund. Çdo regjistrim i {{module_name}} përbën një shitje të mundshme dhe përfshin të dhënat përkatëse të shitjes, si dhe ndërlidhet me regjistrime të tjera të rëndësishme si p.sh. {{quotes_module}}, {{contacts_module}} etj.

- Modifiko fushën e regjistrimit duke klikuar në fushë individuale ose në butonin "Modifiko".
...
- Ndërvepro me komentet e përdoruesit dhe shiko historikun e ndryshimit të regjistrimit në {{activitystream_singular_module}} duke kaluar nga paneli majtas poshtë tek "Transmetimi i aktivitetit".
...
- Veprime të tjera shtesë disponohen në menynë "Veprimet" që shfaqet në të djathtë të butonit "Modifiko".',
    ...
    'LBL_HELP_CREATE' => 'Moduli {{plural_module_name}} mundëson gjurmimin e shitjeve individuale dhe artikujve të linjës që u përkasin këtyre shitjeve, nga fillimi deri në fund. Çdo regjistrim i {{module_name}} përbën shitje të mundshme dhe përfshin të dhënat përkatëse të shitjes, si dhe ndërlidhet me regjistrime të tjera të rëndësishme, si p.sh. {{quotes_module}}, {{contacts_module}} etj.

Për të krijuar një {{module_name}}:
1. Jep vlerat për fushat sipas dëshirës.
 - Fushat e shënuara me "Të domosdoshme" duhet të plotësohen para se të ruhen.
