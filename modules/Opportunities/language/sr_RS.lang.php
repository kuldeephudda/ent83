...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'Evidencija komentara',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modul {{plural_module_name}} vam omogućava da pratite pojedinačne prodaje od početka do kraja. Svaki zapis o modulu {{module_name}} predstavlja potencijalnu prodaju i uključuje relevantne podatke o prodaji kao i o drugim važnim zapisima kao što su {{quotes_module}}, {{contacts_module}}, itd. Modul {{module_name}} će obično proći kroz nekoliko Faza prodaje dok ne bude označen kao „Zatvoren dobitak” ili „Zatvoren gubitak”.Moduli {{plural_module_name}} mogu dodatno da se iskoriste upotrebom Sugar-ovog {{forecasts_singular_module}} modula kako bi se bolje razumeli i predvideli trendovi prodaje, kao i da bi se posao usmerio na postizanje prodajnih kvota.',
...
- Pogledajte ili izmenite linkove ka ostalim zapisima u podpanelim tako što ćete prebaciti donje levo okno na „Prikaz podataka”. 
...
- Dodatne radnje su dostupne u padajućem meniju Radnje koji se nalazi desno od dugmeta Uredi.',
