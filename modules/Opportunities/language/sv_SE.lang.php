...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}-modulen tillåter dig att följa individuella försäljningar från början till slut. Varje {{module_name}}-post representerar en möjlig försäljning och inkluderar relevant säljdata och relaterar även till andra viktiga poster som t ex {{quotes_module}}, {{contacts_module}}, etc. Ett {{module_name}} kommer vanligen att utvecklas genom flera säljfaser tills det markeras antingen "Stängd vunnen" eller "Stängd förlorad" {{plural_module_name}} kan förbättras ännu mer genom användning av Sugar:s {{forecasts_singular_module}}ing module för att förstå och förutsäga förväntad försäljning samt även fokusera arbetet på att uppnå säljmål.',
