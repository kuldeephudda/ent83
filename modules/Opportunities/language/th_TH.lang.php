...
//END DON'T CONVERT
    ...
    'LBL_COMMENTLOG' => 'บันทึกความคิดเห็น',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'โมดูล {{plural_module_name}}ช่วยให้คุณสามารถติดตามการขายแต่ละรายการได้ตั้งแต่ต้นจนจบ ข้อความบันทึก {{module_name}} แต่ละฉบับจะเป็นตัวแสดงการคาดการณ์การขาย และรวมถึงข้อมูลการขายที่เกี่ยวข้อง พร้อมทั้งข้อมูลที่เกี่ยวกับข้อความบันทึกที่สำคัญอื่น ๆ เช่น {{quotes_module}} และ {{contacts_module}} เป็นต้น โดยหลักแล้ว {{module_name}} จะดำเนินก้าวหน้าไปโดยผ่านขั้นตอนการขายหลายขั้นตอน จนกว่ามันจะถูกทำเครื่องหมาย "ปิดได้กำไร" หรือ "ปิดขาดทุน" {{plural_module_name}}ยังสามารถนำมาใช้ประโยชน์ได้แม้จะเป็นในอนาคตโดยการใช้โมดูล {{forecasts_singular_module}} ของ Sugar เพื่อทำความเข้าใจ และพยากรณ์เทรนด์การขาย พร้อมมุ่งเน้นการทำงานเพื่อให้บรรลุโควตาการขาย',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'โมดูล {{plural_module_name}} ช่วยให้คุณสามารถติดตามการขายแต่ละรายการ และสินค้าในไลน์ที่เป็นของการขายเหล่านั้นตั้งแต่ต้นจนจบ ข้อความบันทึก {{module_name}} แต่ละข้อความอธิบายการขายที่คาดคะเนไว้ และข้อมูลการขายที่เกี่ยวข้องกัน รวมถึงข้อมูลสำคัญอื่น ๆ ที่เกี่ยวข้อง เช่น {{quotes_module}} และ{{contacts_module}} เป็นต้น

- แก้ไขช่องข้อความของบันทึกนี้โดยคลิกลงบนช่องแต่ละช่อง หรือที่ปุ่มแก้ไข 
- ดูหรือแก้ไขลิงก์ไปยังบันทึกอื่นในแผงข้อมูลย่อยโดยสลับหน้าต่างด้านล่างซ้ายเป็น "การดูข้อมูล" 
