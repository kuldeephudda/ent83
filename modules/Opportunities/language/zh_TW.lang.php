...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} 模組允許您從開始到結束跟蹤單個銷售。每個 {{module_name}} 記錄都表示潛在的銷售, 並包括相關的銷售資料以及與 {{quotes_module}}、 {{contacts_module}}等其他重要記錄相關的資訊。 {{module_name}} 通常會在多個銷售階段取得進展, 直到標記為 "已關閉" 或 "已關閉的丟失"。 通過使用Sugar的 {{forecasts_singular_module}}模組來瞭解和預測銷售趨勢以及實現銷售配額的重點工作, 可以進一步利用 {{plural_module_name}}。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} 模組允許您跟蹤單個銷售和屬於這些銷售的行項從開始到結束。每個 {{module_name}} 記錄都表示潛在的銷售, 並包括相關的銷售資料以及與 {{quotes_module}}、 {{contacts_module}} 等其他重要記錄相關的資訊。
...
- “編輯”按鈕右側的下拉“操作”選單提供其他操作選項。',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}} 模組允許您跟蹤單個銷售和屬於這些銷售的行項從開始到結束。每個 {{module_name}} 記錄都表示潛在的銷售, 並包括相關的銷售資料以及與 {{quotes_module}}、 {{contacts_module}} 等其他重要記錄相關的資訊。
