 ...
 * PLACE ANY CUSTOMIZATIONS IN W_Warehouse
 */


class W_Warehouse_sugar extends Basic {
    public $new_schema = true;
    public $module_dir = 'W_Warehouse';
    public $object_name = 'W_Warehouse';
    public $table_name = 'w_warehouse';
    ...
    public $shippingaddress_postalcode;
